#include <stdio.h>
#include <stdlib.h>
/* Þekildeki listeyi içten dýþa sarmal þeklinde oluþturur listenin elemanlarý üzerinde sað,sol,yukarý ve aþaðý hareketleri yapýlabilir
 * Listeden istenilen 2 sayý arasýnda yol almak için hangi sayýlardan geçilir ve kaç hareket yapýlýr bulan algoritma
 * X ve Y deðerlerine sahip karelerin arasýnda ilerlemek için x ve y aðaçlarý bulunur. Bir tane olan X aðacý her deðerini için bir Y aðacý bulundurur.
 * Örnek olarak x=2 y=5 bu durumda x aðacýnda 2 bulunur ve 2'nin y aðacýna gidilir. Orda da 5 deðeri bulunur. Bulunan node içerisinde o koordinattaki struct kare bulunur
 */
struct kare{
    int deger;
    int x;
